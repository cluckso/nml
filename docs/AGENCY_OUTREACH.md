# Agency Partnership Program — CallGrabbr
...
- Voicemail captures only 5-15% of callers
- CallGrabbr captures 80-95%
...
### Cold Email Template (Detailed)

**Subject:** Partnership opportunity — help your contractor clients capture more leads

```
Hi [Name],

I'm reaching out because [Agency Name] works with contractors and local service businesses.

Quick problem we solve:
...
```
Hi [Name] — saw you work with [contractors/plumbers/HVAC companies].
...
Search for agencies that serve:
...
1. Email partners@callgrabbr.com
2. We'll set up your referral tracking
3. Share your unique link with clients
4. Get paid monthly
...
**Email:** partners@callgrabbr.com  
**Website:** https://callgrabbr.com
