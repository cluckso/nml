...
export const META_AB_VARIANTS: Record<string, MetaAbAdVariant> = {
  "a-voicemail": {
    ...
    description: "7-day free trial · No card · Setup in 5 min",
    primaryText: `80% of callers won't leave voicemail — they call the next company on Google.

You're on a ladder, under a sink, or driving between jobs. The phone rings. You can't answer. That $350–$600 emergency call? Gone.
...
One captured job pays for months of service. Plans from $99/mo.
...
Start your 7-day free trial — no credit card required.`,
    ...
    reels: {
      ...
      storyboard: [
        ...
        { time: "5-7s", visual: "Phone leaks flying dollar bills", caption: "28% of business calls go unanswered." },
      ...
      videoPrompt:
        "Vertical 9:16, 15 seconds, fast cuts 0.7s each, bold white captions with red accent on hook line, dark navy UI frames, electric blue glow on CallGrabbr moments. Scene 1: phone ringing alarm red text YOUR PHONE IS LOSING YOU JOBS. Scene 2: stylized contractor silhouette on ladder phone vibrating pocket not photorealistic. Scene 3: dollar bills flying off phone screen. Scene 4: split screen competitor phone answered with blue AI glow speech bubble Thanks for calling whats the address. Scene 5: smartphone New Lead notification card name phone urgency. Scene 6: CallGrabbr logo end card 7-day free trial no card. No watermarks.",
    },
  },
...
Built for local service businesses. 7-day free trial, 40 call minutes, no credit card. About 5 minutes to set up.
...
Get your evenings back.`,
    ...
    reels: {
      ...
      storyboard: [
        ...
        { time: "13-15s", visual: "Logo + CTA", caption: "7-day free trial · callgrabbr.com" },
      ],
      videoPrompt:
        "Vertical 9:16 15 second ad, warm but stylized not photorealistic, family dinner table scene transitions to dark navy CallGrabbr UI with electric blue neon accents, smartphone shows lead notification, bold mobile captions each scene, emotional relief tone not corporate, end card CallGrabbr logo 7-day free trial no card required",
    },
  },
...
Stop losing jobs to awkward timing. Try it free for 7 days — no card, 40 minutes included.
...
Call the demo line on our site if you want to hear it first.`,
    ...
    reels: {
      ...
      storyboard: [
        ...
        { time: "11-15s", visual: "Logo", caption: "7-day free trial — no card" },
      ],
      videoPrompt:
...
Your missed call shouldn't be their next job. Plans from $99/mo. One captured job pays for months.
...
Start your 7-day free trial. No credit card required.`,
    ...
    reels: {
      ...
      videoPrompt:
        "Vertical 9:16 15 second ad split screen competitor steal narrative, stylized not photorealistic, dark navy and electric blue CallGrabbr brand, bold captions, missed call vs new lead contrast, end card logo 7-day free trial",
    },
  },
}
